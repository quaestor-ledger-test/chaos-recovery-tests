# quaestor-ledger-test/chaos-recovery-tests

Deterministic fault-injection, crash recovery, retry, partition, duplicate-delivery, and convergence tests.

This repository is the `chaos` deep-test suite for `quaestor-ledger`. It is intentionally dependency-light and deterministic so failures can be reproduced locally without production credentials or customer data.
